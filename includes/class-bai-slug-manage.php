...
class BAI_Slug_Manage {
    ...
    public function render() {
        ...
        echo '</select></label> ';
        echo '<label>' . esc_html__( '属性筛�?, 'wp-ai-slug' ) . '�?select name="attr">';
        ...
        echo '</select></label> ';
        submit_button( '筛�?, 'secondary', '', false );
        echo '</form>';
        ...
        echo '<p class="description">默认�?ID 倒序（越新越靠前）。编辑后会将属性标记为“人工修改”，以避免后续被覆盖�?/p>';
        echo '</div>';
    }
